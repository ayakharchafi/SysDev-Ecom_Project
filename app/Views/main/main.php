...
<head>
    ...
    <link rel="stylesheet"
        href="/tern_app/SysDev-Ecom_Project/public/css/style_main.css">
    <link rel="stylesheet"
...
<body onload="getTheme()">
                ...
                <div class="action-buttons">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content" id="functionsDropdown">
                            <div class="dropdown-item"><?= _('Data Tracking')?>
                            </div>
                            <div class="dropdown-item" id="modifyBtn">
                                <?= _('Modify User')?></div>
                            <div class="dropdown-item"><?= _('Create Report')?>
                            </div>
                            <div class="dropdown-item create-client-btn"
                                data-client-type="mk"><?= _('Create Client')?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="settingsModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>This is a placeholder for the settings page. The actual
                    settings functionality will be implemented in the future.
                </p>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary"
                    id="closeSettingsBtn">Cancel</button>
    ...
    <div id="logoutModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary"
                    id="cancelLogoutBtn"><?= _('Cancel')?></button>
                <button class="btn btn-danger"
                    id="confirmLogoutBtn"><?= _('Sign out')?></button>
            </div>
        </div>
    </div>
