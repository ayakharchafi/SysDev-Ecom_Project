...
<div class="create-client-container">
    <h2>Create MK Row</h2>
    <form id="createRowForm" class="create-client-form">
        ...
        <div class="form-group">
            <label for="location_address">Building Address</label>
        ...
        <div class="form-row">
            <div class="form-group half">
                <label for="first_date_of_coverage">Stay Start Date</label>
                <input type="date" id="first_date_of_coverage" name="first_date_of_coverage" required>
            </div>
            
            <div class="form-group half">
                <label for="last_date_of_coverage">Stay End Date</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group half">
                <label for="number_of_days_occupied">Days Occupied</label>
        ...
        <div class="form-row">
            ...
            <div class="form-group half">
                <label for="premium_collected">Premium Collected</label>
