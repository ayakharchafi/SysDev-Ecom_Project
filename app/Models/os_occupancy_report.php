...
public function getMetisIdNumber()
{
    return $this->metis_id_number;
}

public function setMetisIdNumber($metis_id_number)
{
    $this->metis_id_number = $metis_id_number;
}
...
public function getShleternOasisCoverage()
{
    return $this->shletern_oasis_coverage;
}

public function setShleternOasisCoverage($shletern_oasis_coverage)
{
    $this->shletern_oasis_coverage = $shletern_oasis_coverage;
}
...
public function setTernkeyTenantCoverage($ternkey_tenant_coverage)
{
    ...
    public function readOne() {
        $query = "SELECT * FROM os_occupancy_report WHERE id = :reportID";
        $stmt = $this->dbConnection->prepare($query);
        $stmt->bindParam(':reportID', $this->id);
        $stmt->execute();
        return $stmt->fetchAll(\PDO::FETCH_CLASS, Os_occupancy_report::class);
    }
